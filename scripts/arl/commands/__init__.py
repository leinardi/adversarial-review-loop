...
Every module exposes ``run(argv: list[str]) -> int``, and :mod:`arl.cli` imports the one
...
def plugin_root() -> str:
    ...
    """
    return os.environ.get("CLAUDE_PLUGIN_ROOT") or str(arl.PLUGIN_ROOT)
...
def entrypoint() -> str:
    ...
    """
    return f"{plugin_root()}/scripts/arl.sh"
