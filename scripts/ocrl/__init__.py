"""Python implementation of the ``opencode-review-loop`` gate.
...
supported entrypoint is ``scripts/ocrl-bootstrap.py``, run by absolute path under
``python3 -I``.
"""
...
#: Directory holding this package, i.e. ``<plugin>/scripts/ocrl``.
